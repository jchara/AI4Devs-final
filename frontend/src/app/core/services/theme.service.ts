...
export class ThemeService {
  ...
  private applyTheme(theme: Theme): void {
    ...
    if (theme === 'dark') {
      ...
      root.style.setProperty('--color-accent-rgb', '102, 217, 239');
      ...
      root.style.setProperty('--color-success-rgb', '76, 175, 80');
      root.style.setProperty('--color-info', '#64B5F6');
      root.style.setProperty('--color-info-rgb', '100, 181, 246');
      root.style.setProperty('--color-warning', '#FFA726');
      root.style.setProperty('--color-warning-rgb', '255, 167, 38');
      ...
      root.style.setProperty('--color-primary-hover', '#6A21C5');
      root.style.setProperty('--color-primary-rgb', '125, 43, 227');
      root.style.setProperty('--color-accent', '#66C6EA');
      root.style.setProperty('--color-accent-rgb', '102, 198, 234');
      ...
      root.style.setProperty('--color-info-rgb', '33, 150, 243');
      root.style.setProperty('--color-warning', '#FF9800');
      root.style.setProperty('--color-warning-rgb', '255, 152, 0');
